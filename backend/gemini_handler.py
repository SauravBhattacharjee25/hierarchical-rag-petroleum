...
def get_working_model(api_key: str) -> Any:
    """
...
def initialize_gemini(api_key: str = None) -> Any:
    """
...
def generate_answer(model: Any, prompt: str) -> str:
    """
...
def chat_with_context(model: Any, question: str, 
                      context: str) -> str:
    """
