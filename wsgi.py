#!/usr/bin/env python3
"""
WSGI Entry Point for Hierarchical RAG System
For use with Gunicorn or other production WSGI servers
"""
import sys
import os
...
if __name__ == '__main__':
    # This is only for development; use Gunicorn in production
